...
<div style="border: 3px solid <?= $backgroundnya ?>;" class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="<?= site_url('bill/filterunpaid'); ?>" method="post">
...
<div style="border: 3px solid <?= $backgroundnya ?>;" class="card shadow mb-4">
    <div style="border-bottom: 3px solid <?= $backgroundnya ?>;" class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color : <?= $backgroundnya ?>"> Data Tagihan Belum Bayar Bulan Ini : <font style="text-align:left; font-weight:bold; color:red">Rp. <?= indo_currency($grandtotal) ?></font>
        </h6>
    </div>
    <div class="card-body">
                        ...
                        <tbody>
                            ...
                            foreach ($bill as $r => $data) { ?>
                                ...
                                <tr style="background-color: <?= $bg ?>; color: black;">
                                    ...
                                    <td><?= $data->name ?></td>
                                    <td style="text-align: center"><?= $due_date; ?> <?= indo_month($data->month) ?> <?= $data->year ?></td>
                                    <td style="font-weight: bold;text-align: center">Rp. 
                                        <?php $query = "SELECT *
                                    FROM `invoice_detail`
                                    ...
                                    <td style="text-align: center">
                                        <?php if ($data->status == 'BELUM BAYAR') { ?>
                                            <a href="" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#selectpaper<?= $data->invoice ?>" title="Print Invoice"><i class="fa fa-print" style="text-decoration: none; color: red; width: 25px; font-size: 20px;"></i></a>
                                        <?php } ?>
                                        <?php if ($data->status == 'SUDAH BAYAR') { ?>
                                            <a href="" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#selectpaper<?= $data->invoice ?>" title="Print Invoice"><i class="fa fa-print" style="text-decoration: none; color: green; width: 25px; font-size: 20px;"></i></a>
                                        <?php } ?>
                                        <?php if ($data->status == 'BELUM BAYAR') { ?>
                                            <a href="" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#BayarModal<?= $data->invoice_id ?>" title="Lunasi Tagihan"><i class="fas fa-money-bill-alt" style="text-decoration: none; color: orange; width: 25px; font-size: 20px;"></i></a>
                                        <?php } ?>
                                        <a href="<?= site_url('bill/detail/' . $data->invoice) ?>" class="btn btn-sm btn-outline-secondary" title="Lihat"><i class="fa fa-eye" style="text-decoration: none; color: blue; width: 25px; font-size: 20px;"></i></a><br>
                                        <?php
                                        ...
                                        ?>
                                            <a href="<?php echo $pesan1; foreach($dataBank as $bank){ echo '=>%20' . $bank->name . '%20:%20' . $bank->no_rek . '%0A%20%20%20%20%20a/n%20' . $bank->owner . '%0A'; } echo $pesan2 ?>" target="_blank" class="btn btn-sm btn-outline-secondary" title="Kirim Manual"><i class="fab fa-whatsapp" style="text-decoration: none; color: black; width: 25px; font-size: 20px;"></i></a>
                                        <?php } ?>
                                        <?php
                                        ...
                                        ?>
                                            <a href="https://api.whatsapp.com/send?phone=<?= $no_whatsapp ?>&text=<?= $pesan ?>" target="_blank" class="btn btn-sm btn-outline-secondary" title="Kirim Manual"><i class="fab fa-whatsapp" style="text-decoration: none; color: black; width: 25px; font-size: 20px;"></i></a>
                                        <?php } ?>
                                        <?php if ($this->session->userdata('role_id') == 1) { ?>
                                            <a href="<?= site_url('services/detail/' . $data->no_services) ?>" class="btn btn-sm btn-outline-secondary" title="Edit Tagihan"><i class="fa fa-edit" style="text-decoration: none; color: green; width: 25px; font-size: 20px;"></i></a>
                                            <a href="" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#DeleteModal<?= $data->invoice_id ?>" title="Hapus Tagihan"><i class="fa fa-trash" style="text-decoration: none; color: brown; width: 25px; font-size: 20px;"></i></a><br>
                                            <a target="blank" href="<?= site_url('cronjob/aktifmanual/' . $queryCustomer['customer_id']) ?>" class="btn btn-sm btn-outline-secondary" title="Aktivasi Manual"><i class="fa fa-check" style="text-decoration: none; color: black; width: 25px; font-size: 20px;"></i></a>
                                            <a target="blank" href="<?= site_url('cronjob/isolirmanual/' . $queryCustomer['customer_id']) ?>" class="btn btn-sm btn-outline-secondary" title="Isolir Manual"><i class="fa fa-close" style="text-decoration: none; color: black; width: 25px; font-size: 20px;"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>

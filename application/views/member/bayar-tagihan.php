					...
					<div class="col-lg">
						<div class="box box-primary">
							<div class="box-body box-profile">
								<?= form_open_multipart('bill/confirmSaldo'); ?>
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group mb-2">
											...
											<input type="hidden" class="form-control" id="name" name="name" value="<?= $bill['name'] ?>" readonly>
											<input type="hidden" class="form-control" autocomplete="off" name="date_payment" value="<?= date('d/m/Y H:i:s'); ?> WIB" readonly>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group mb-2">
											...
											<input type="number" class="form-control" id="nominal" name="nominal" value="<?= $tagihan ?>" readonly>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group mb-2">
								...
								<div class="form-group mb-2">
									...
									<select class="form-control" name="metode_payment" style="font-weight: bold;" id="metode_payment" required>
										<option value="Bayar Pakai Saldo">Saldo Utama (Rp. <?= indo_currency($user['saldo']); ?>)</option>
									</select>
								</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						atau konfirmasi pembayaran Anda melalui <br>

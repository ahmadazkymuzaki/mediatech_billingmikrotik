...
<div style="border: 3px solid <?= $backgroundnya ?>;" class="card shadow mb-4">
    <div style="border-bottom: 3px solid <?= $backgroundnya ?>;" class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color : <?= $backgroundnya ?>"> Data Tagihan Semua Transaksi : <font style="text-align:left; font-weight:bold; color:black">Rp. <?= indo_currency($grandtotal) ?></font>
        </h6>
    </div>
    <div class="card-body">

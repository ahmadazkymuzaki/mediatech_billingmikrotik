...
<div class="container mt-2">
    <div style="border: 3px solid <?= $backgroundnya ?>;" class="card">
        <div style="border-bottom: 3px solid <?= $backgroundnya ?>;" class="card-header">
            Catatan Pelanggan <?= $company['company_name'] ?>
        </div>
        <div class="card-body">
            <form action="<?= site_url('setting/editcatatan/') ?><?= $company['id'] ?>" method="POST">
                <textarea name="catatan" id="editor1" class="form-control"><?= $company['catatan'] ?></textarea>

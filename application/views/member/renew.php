    ...
    <div class="col-12">
        <div class="card shadow mb-3" style="border: solid 1px grey;">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold" style="color : <?= $backgroundnya ?>">Renew / Up Speed</h6>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <form action="<?= site_url('member/tambahlayanan') ?>" method="POST">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <select class="form-control" name="mydeskripsi" id="mydeskripsi">
                                                ...
                                                ?>
                                                    <option value="<?= $row3->p_item_id ?>"><?= $row3->name ?> - Rp. <?= indo_currency($row3->price) ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-4 col-12">
                                        ...
                                        <input type="hidden" class="form-control" readonly value="Renew  / Up Speed" name="judul_layanan" id="judul_layanan">

<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <a href="" data-toggle="modal" data-target="#ModalAdd" class="d-sm-inline-block btn btn-sm btn-<?= $company['theme'] ?> shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Slide</a>
                    ...
                    foreach ($slide as $r => $data) { ?>
                        <tr>
                            ...
                            <td class="text-center" width="160px">
                                <form>
                                    <a class="btn btn-xs btn-<?= $company['theme'] ?>" href="#ModalEdit<?= $data->slide_id ?>" data-toggle="modal" title="Edit"><i class="fa fa-edit"> </i>Edit </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= site_url('master/add_slide') ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?= $data->slide_id ?>" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= site_url('master/edit_slide') ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalHapus<?= $data->slide_id ?>" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= site_url('master/del_slide') ?>" enctype="multipart/form-data">
                            <input type="hidden" name="slide_id" value="<?= $data->slide_id ?>" class="form-control">

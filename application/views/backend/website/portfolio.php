...
<div style="border: 3px solid <?= $backgroundnya ?>;" class="card shadow mb-4">
    <div style="border-bottom: 3px solid <?= $backgroundnya ?>;" class="card-header py-3">
        <h6 class="m-0 font-weight-bold" style="color : <?= $backgroundnya ?>">Data Portfolio</h6>
                ...
                <tbody>
                    ...
                    foreach ($portfolio as $r => $data) { ?>
                        <tr>
                            <td width="35px"><?= $no++ ?>.</td>
                            <td> <?= $data->name ?> </td>
                            <td><img src="<?= site_url('assets/images/portfolio/') ?><?= $data->picture ?>" alt="" style="width:100px; height:100px"></td>
                            <td> <?= $data->cat_name ?> </td>
                            <td> <?= $data->description ?> </td>
                            <td class="text-center" width="160px">
                                <form>
                                    <a class="btn btn-xs btn-<?= $company['theme'] ?>" href="#ModalEdit<?= $data->port_id ?>" data-toggle="modal" title="Edit"><i class="fa fa-edit"> </i>Edit </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= site_url('master/addPortfolio') ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?= $data->port_id ?>" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= site_url('master/edit_portfolio') ?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalHapus<?= $data->port_id ?>" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= site_url('master/del_portfolio') ?>" enctype="multipart/form-data">
                            <input type="hidden" name="port_id" value="<?= $data->port_id ?>" class="form-control">
